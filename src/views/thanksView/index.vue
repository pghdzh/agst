...
const acknowledgements = reactive([
  { nickname: '雪_霁__', suggestion: '如果骄阳落下，那就让我来成为新的灼阳(首页大标题)' },
...
.ack-page {
  ...
  min-height: 100vh;
  padding-top: 64px;
  background: linear-gradient(135deg, #0d0f17, #1a1c29, #0d0f17);
...
.page-title {
  ...
  background: linear-gradient(90deg, #C64830 0%, #E1D7BD 80%);
  -webkit-background-clip: text;
  color: transparent;
  text-shadow: 0 0 8px rgba(255, 205, 140, 0.6);
}
...
.ack-list {
  ...
  .ack-item {
    ...
    .nickname {
      font-weight: bold;
      margin-right: 0.5rem;
       background: linear-gradient(90deg, #E1D7BD 0%, #ffd78a 80%);
      -webkit-background-clip: text;
      color: transparent;
