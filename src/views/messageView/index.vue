        ...
        >
          <div class="message-meta">
            ...
            <div class="shouan-icon" role="button" tabindex="0">
              <!-- 保存为 vite.svg 并放到项目的 public/ 或根目录覆盖 vite.svg -->
              <svg
                ...
                height="64"
                role="img"
                aria-label="Augusta icon"
              >
                <defs>
                  <radialGradient id="g" cx="50%" cy="40%" r="70%">
                    <stop offset="0%" stop-color="#FFD27A" />
                    <stop offset="45%" stop-color="#FFAA4D" />
                ...
                <!-- 太阳辐射（简化的辐射光） -->
                <g transform="translate(32,18)" opacity="0.9">
                  <path
                    d="M0,-12 L1,-20 L2,-12 Z"
                    transform="rotate(0)"
                    fill="#FFE6B3"
                  />
                  <path
                ...
                <g transform="translate(32,34)" filter="url(#s)">
                  <!-- 刃身 -->
                  <path
                    d="M0,-22 L6,18 L0,14 L-6,18 Z"
                    fill="#2E1A0E"
                    opacity="0.95"
                  />
                  <path d="M0,-20 L4.5,16 L0,12 L-4.5,16 Z" fill="#FFDCA0" />
                  <!-- 刃心高光 -->
                  <path
                    d="M0,-18 L1.5,12 L0,10 L-1.5,12 Z"
                    fill="#FFF4DA"
                    opacity="0.9"
                  />
                  <!-- 刀柄（简洁） -->
                  <rect
                    ...
                    fill="#AD7A3F"
                  />
                  <circle cx="0" cy="26" r="2.2" fill="#6B3F1F" />
                </g>

                <!-- 简化皇冠/饰物（刃上方） -->
                <g transform="translate(32,12)">
                  <path
                    d="M-10,6 L-4,-2 L0,4 L4,-2 L10,6 L8,8 L0,0 L-8,8 Z"
                    fill="#FFD27A"
                    opacity="0.95"
                  />
                </g>
...
/* 奥古斯塔色板（变量名保持不变） */
$bg-start: #090608; // 深海夜色（更冷的湮灭底）
$bg-end: #2a1208; // 次深底（深紫-海蓝过渡）
